...
urlpatterns = patterns('',
    ...
    #url(r'^evaluations/([0-9]+)','snapp.views.evaluation',name='evaluation'),  # Viewing a submitted evaluation
    ...
    url(r'^view_evaluations/([0-9]+)', 'snapp.views.view_evaluations', name='view_evaluations'),
